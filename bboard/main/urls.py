...
from .views import (
    ...
    BBLogout, ChangeUserInfoView, BBPaswordChangeView,
    RegisterUserView, RegisterDoneView, user_activate,
    DeleteUserView, BBPaswordResetView, BBPasswordResetDoneView,
...
urlpatterns = [
    ...
    path('accounts/password/change/',
         BBPaswordChangeView.as_view(), name='password_change'),
    path('accounts/password_reset/confirm/<uidb64>/<token>/',
         BBPasswordResetConfirmView.as_view(), name='password_reset_confirm'),
    path('accounts/password_reset/complite/',
         BBPasswordResetCompleteView.as_view(), name='password_reset_complete'),
    path('accounts/password_reset/done/',
         BBPasswordResetDoneView.as_view(), name='password_reset_done'),
    path('accounts/password_reset/',
         BBPaswordResetView.as_view(), name='password_reset'),
