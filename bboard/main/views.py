    ...
    if request.method == 'POST':
        ...
        if c_form.is_valid():
            ...
            messages.add_message(
                request, messages.WARNING, 'Comment not added')
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if formset.is_valid():
                formset.save()
                messages.add_message(
                    request, messages.SUCCESS, 'Advertisement edited')
...
def profile_bb_delete(request, pk):
    ...
    if request.method == 'POST':
        bb.delete()
        messages.add_message(request, messages.SUCCESS, 'Adverisement deleted')
        return redirect('main:profile')
    else:
        context = {'bb': bb}
...
class ChangeUserInfoView(SuccessMessageMixin, LoginRequiredMixin, UpdateView):
    ...
    success_message = 'Users profile updated'
...
class BBPaswordChangeView(SuccessMessageMixin, LoginRequiredMixin, PasswordChangeView):
    ...
    success_url = reverse_lazy('main:profile')
    success_message = 'Password successfuly changed'


class BBPaswordResetView(PasswordResetView):
